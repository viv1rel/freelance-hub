...
return [
    ...
    'bootstrappers' => [
        ...
        // FilesystemTenancyBootstrapper::class — disabled: we don't use per-tenant storage,
        // and it rewrites asset() URLs to /tenancy/assets/ which require domain identification.
