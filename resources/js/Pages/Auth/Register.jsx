    ...
    return (
        <AuthLayout>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="workspace_name" className="block text-sm font-medium text-foreground">
                        Название рабочего пространства <span className="text-destructive">*</span>
                    </label>
                    <input
                        id="workspace_name"
                        type="text"
                    ...
                    {errors.workspace_name && (
                        <p className="mt-1 text-sm text-destructive">{errors.workspace_name}</p>
                    )}
                </div>
                ...
                >
                    {processing ? 'Создание...' : 'Создать аккаунт'}
                </button>
